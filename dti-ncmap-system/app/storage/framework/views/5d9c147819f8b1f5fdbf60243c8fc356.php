...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            <a href="<?php echo e(route('admin.offices.edit', $office)); ?>" class="btn btn-sm btn-primary">
...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div><?php echo e($office->complete_address); ?></div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                ...
                                <?php echo e($office->contact_number); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:<?php echo e($office->email_address); ?>"><?php echo e($office->email_address); ?></a>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                ...
                                <?php echo e($office->service_hours); ?>
                ...
                <div class="mt-4">
                    ...
                    <div class="p-3 bg-light rounded"><?php echo e($office->office_description); ?></div>
                </div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div id="office-map" style="height: 400px; background-color: #f0f0f0;">
                    <div class="d-flex align-items-center justify-content-center h-100">
                        <div class="text-center">
                            ...
                            <small class="text-muted"><?php echo e($office->latitude); ?>, <?php echo e($office->longitude); ?></small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="<?php echo e(route('admin.offices.edit', $office)); ?>" class="btn btn-primary w-100 mb-2">
                    <i class="bi bi-pencil"></i> Edit Office
                </a>
                
                <a href="<?php echo e(route('map.office.show', $office)); ?>" class="btn btn-info w-100 mb-2" target="_blank">
                    <i class="bi bi-map"></i> View on Public Map
                </a>
                
                <?php if($office->staffMembers->count() > 0): ?>
                <a href="<?php echo e(route('admin.staff.index', ['location_id' => $office->id])); ?>" class="btn btn-outline-primary w-100 mb-2">
            ...
            <div class="card-body" style="max-height: 400px; overflow-y: auto;">
                    ...
                    <?php $__currentLoopData = $office->staffMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mb-3 p-2 border rounded">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <span class="badge bg-<?php echo e($staff->type_code === 'A' ? 'primary' : ($staff->type_code === 'B' ? 'info' : 'success')); ?>">
                                    Type <?php echo e($staff->type_code); ?>

                                </span>
                            </div>
                            <div class="mt-2">
                                <a href="<?php echo e(route('admin.staff.show', $staff)); ?>" class="btn btn-sm btn-outline-primary">
                ...
                <?php else: ?>
                    <div class="text-center py-4 text-muted">
                        ...
                        <a href="<?php echo e(route('admin.staff.create')); ?>" class="btn btn-sm btn-primary">
            ...
            const infoWindow = new google.maps.InfoWindow({
                content: `
                    <div>
                        ...
                        <p><?php echo e($office->complete_address); ?></p>
                    </div>
                `
            });
...
<script async defer 
    src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(env('GOOGLE_MAPS_API_KEY')); ?>&callback=initMap">
</script>
<?php endif; ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\3rdweek\dti-ncmap-system\resources\views/admin/offices/show.blade.php ENDPATH**/ ?>