                        ...
                        <div class="mb-3 p-3 border rounded reminder-<?php echo e(strtolower($reminder->priority)); ?>">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <i class="bi bi-clock"></i> <?php echo e($reminder->reminder_time_input ? $reminder->reminder_time_input : 'All day'); ?>
                        ...
                        <div class="mb-3 p-2 border-start border-3 border-<?php echo e($reminder->priority_color); ?>">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <i class="bi bi-clock"></i> <?php echo e($reminder->reminder_time_input); ?>
